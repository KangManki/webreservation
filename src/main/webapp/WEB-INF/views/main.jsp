...
<div id="container">
        <div class="header">
            <header class="header_tit">
                <h1 class="logo">
                    ...
                    <a href="./NewFile.jsp" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span> </a>
                </h1>
    ...
    <li class="promotion_item item" style="background-image: url(${path}/resources/img/{file_name});">
        <a href="#"> <span class="img_btm_border"></span> <span class="img_right_border"></span> <span class="img_bg_gra"></span>
            <div class="event_txt">
                <h4 class="event_txt_tit">{description}</h4>
                <p class="event_txt_adr">{content}</p>
                <p class="event_txt_dsc">{place_name}</p>
            </div>
        </a>
    </li>
    </script>
        ...
        <li class="item">
            <a href="detail?id={id}" class="item_book">
                <div class="item_preview">
                    <img alt="{description}" class="img_thumb" src="${path}/resources/img/{productImageUrl}">
